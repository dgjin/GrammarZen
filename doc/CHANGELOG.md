...
### 新增
- **头像上传功能**：
  - 用户现在可以直接点击个人中心头像区域，从本地上传图片作为头像。
  - 图片将自动上传至 Supabase Storage 的 `avatars` 存储桶（需预先配置）。
  - 支持 JPG, PNG, GIF, WEBP 格式，文件大小限制为 2MB。

## [1.7.0] - 2024-05-27
### 新增
- **用户个人中心**：
  - 新增用户头像、昵称和密码管理功能。
  - 支持自定义头像 URL 或选择系统预设头像。
  - 头部导航栏优化，登录状态下显示用户头像和昵称。
- **文档维护**：
  - 更新日志文件移动至 `doc/` 目录下统一管理。
